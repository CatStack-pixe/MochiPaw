  ...
  C: CollectionMarker,
{
  ...
  /// With an explicit builder path, metadata follows the current directory.
  /// The next build still uses the explicit path supplied to that builder.
